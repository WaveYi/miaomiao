            ...
            <div id="content">
                <div class="movie_menu">
                    <router-link tag="div" to="/movie/city" class="city_name">
                        <span>{{ $store.state.city.nm }}</span><i class="iconfont icon-icon-test  "></i>
                    </router-link>
...
<style scoped>
/* #content{height:45px;display:block;} */
...
.movie_menu .city_name.router-link-active{color:#ef4238;border-bottom: 2px black solid;}
